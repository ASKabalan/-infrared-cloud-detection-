...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.5\textwidth]{Images/pca3.png} \qquad
  \includegraphics[width=0.4\textwidth]{Images/umap.png}
  \caption{lol}
\end{figure}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.6\textwidth]{Images/hiplot.png}
\end{figure}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.45\textwidth]{Images/MODEL3_ratio80_acc95_confusion_matrix.png} \qquad
  \includegraphics[width=0.45\textwidth]{Images/MODEL3_ratio80_acc95_roc_plot.png}
